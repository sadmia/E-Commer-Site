...
btn_img_1.addEventListener("click", function() {
	full_images.src = "../images/Vegetables/Tomato/1.png";
...
btn_img_2.addEventListener("click", function() {
	full_images.src = "../images/Vegetables/Tomato/2.png";
...
btn_img_3.addEventListener("click", function() {
	full_images.src = "../images/Vegetables/Tomato/3.png";
...
btn_img_4.addEventListener("click", function() {
	full_images.src = "../images/Vegetables/Tomato/4.png";
